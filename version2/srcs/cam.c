...
/*   Updated: 2019/10/04 13:23:44 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_cam_update(t_cam *cam, t_camera_mvt direction, float delta_time)
{
    ...
    if (direction == FORWARD)
        cam->pos = ft_vec3_add(cam->pos, ft_vec3_kmult(velocity, cam->dir));
    else if (direction == BACKWARD)
        cam->pos = ft_vec3_sub(cam->pos, ft_vec3_kmult(velocity, cam->dir));
    /*else if (direction == LEFT)
        cam->pos = ft_vec3_sub(cam->pos, ft_vec3_kmult(velocity, cam->horiz));
    else if (direction == RIGHT)
        cam->pos = ft_vec3_add(cam->pos, ft_vec3_kmult(velocity, cam->horiz));*/
