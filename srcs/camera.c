...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/03 17:10:04 by ebatchas          #+#    #+#             */
/*   Updated: 2019/10/04 05:05:10 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void        ft_camera_matrix(t_camera *cam)
{
    ...
    cam->projection = ft_mat4_perspective(cam->zoom, cam->aspect_ratio, 0.01f, 100.0f);
}
